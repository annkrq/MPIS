        ...
        buttonGetData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!query.isEmpty()) {
                    ...
                    String url = "https://pixabay.com/api/?key=" + BuildConfig.UNSPLASH_ACCESS_KEY + "&q=" + query.replaceAll(" ", "+") + "&image_type=photo&lang=en&orientation=horizontal&per_page=" + LENGTH;
                    Log.d("Query", url);
                    getPhotos(url);
                }
            }
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < LENGTH && i < hits.length(); ++i) {
                            photoList.add(new Photo(hits.getJSONObject(i).getString("webformatURL")));
                        }
